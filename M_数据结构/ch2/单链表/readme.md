...
## **初始化单链表**
  - **不带头结点时(不带头结点就是，L只能指向第一个数据元素，当在第一个数据元素的位置进行插入或删除操作时，要注意让L指向新的结点，L保持指向第一个数据元素的位置)**![在这里插入图片描述](https://img-blog.csdnimg.cn/71967e6350f24d13948054c764fa9ca3.png)
